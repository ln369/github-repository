	...
	<script type="text/javascript">
	 $(function(){
			...
			$("#add").click(function(){
				...
				$.post("${pageContext.request.contextPath}/dept/addDept.do",$("#jobForm").serialize(),
				function (data) {
				    //alert(data);
					if (data == "OK") {
					    alert("部门添加成功！");
    ...
    <td>
    	 <form action="${pageContext.request.contextPath}/dept/addDept" id="deptForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="button" value="添加 " id="add">&nbsp;&nbsp;<input type="reset" value="取消 "></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
