			...
			<c:forEach items="${requestScope.documents}" var="document" varStatus="stat">
				<tr ondblclick="down(${document.id});"  class="main_trbg" align="center" id="data_${stat.index}">
					<td><input type="checkbox" id="box_${stat.index}" value="${document.id}"></td>
					 ...
					 <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/document/updateDocument.do?id=${document.id}">
		...
		<tr>
			<td>
				<ln:pager pageIndex="${pageModel.pageIndex}"
						  ...
						  submitUrl="${pageContext.request.contextPath}/document/findDocument.do?pageModel.pageIndex={0}&ducument.title=${document.title}"/>
			</td>
		</tr>
