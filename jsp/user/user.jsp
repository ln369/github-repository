		    ...
		    <tr class="main_trbg_tit" align="center">
			  ...
			  <c:forEach items="${users}" var="users">
			 	 <tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
						<td><input type="checkbox" id="box_${stat.index}" value="${users.id}"></td>
						...
						<td align="center" width="40px;"><a href="${pageContext.request.contextPath}/modifyUser.do?id=${users.id}">
		...
		<tr>
			<td>
				<ln:pager pageIndex="${pageModel.pageIndex}"
						  ...
						  submitUrl="${pageContext.request.contextPath}/findUser.do?pageIndex={0}&username=${user.username}&status=${user.status}"/>
			</td>
		</tr>
		<!-- 分页标签 -->
