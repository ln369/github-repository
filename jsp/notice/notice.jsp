	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="noticeform" method="post" id="noticeform" action="${pageContext.request.contextPath}/notice/findNotice.do">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
				...
				<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					<td><input type="checkbox" id="box_${stat.index}" value="${notice.id}"></td>
					 <td>${notice.title }</td>
					  ...
					  <td>
						  <%--${notice.create_date}--%>
					  <f:formatDate value="<%=new Date()%>"
								type="date" dateStyle="long"/>
					  </td>
					  <td>${notice.user.username }</td>
					 <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/notice/updateNotice.do?flag=1&id=${notice.id}">
		...
		<tr>
			<td>
				<ln:pager pageIndex="${pageModel.pageIndex}"
						  ...
						  submitUrl="${pageContext.request.contextPath}/notice/findnotice.do?pageIndex={0}"/>
			</td>
		</tr>
